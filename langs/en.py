...
Warning! You need to install requirements only
...
headers_info = ('Headers Info', {
    'file_header': ('File Header',
                    ['Field Name', 'Value', 'Description'],
                    {
                        ...
                        'characteristics': ('Characteristics', [
                            ...
                            'If the image is on the network, copy '
    ...
    'optional_header': ('Optional Header',
                        ['Field Name', 'Value', 'Description'],
                        {
                            ...
                            'sizeOfInitializedData': 'Size of '
                                                     'Initialized data',
                            'sizeOfUninitializedCode': 'Size of '
                                                       'Uninitialized data',
                            ...
                            'operatingSystemVersion': 'Operating '
                                                      'System Version',
                            ...
                            'subsystem': ('Subsystem',
                                          {
                                              ...
                                              2: 'Windows graphical user '
                                                 'interface (GUI) subsystem.',
                                              3: 'Windows character-mode user '
                                                 'interface (CUI) subsystem.',
                                              5: 'OS/2 CUI subsystem.',
                                              7: 'POSIX CUI subsystem.',
                                              9: 'Windows CE system.',
                                              10: 'Extensible Firmware '
                                                  'Interface (EFI) '
                                                  'application.',
                            ...
                            'dllCharacteristics': ('DLL Characteristics', [
                                ...
                                'The image is isolation aware, but '
                                'should not be isolated.',
                                'The image does not use structured '
                                'exception handling (SEH). No handlers can be '
                                'called in this image. ',
                                'Do not bind the image.',
                                'Reserved.', 'A WDM Driver', 'Reserved',
...
data_directory_tab = ('Data Directory', ['Field name', 'Virtual Address',
                                         'Size'],
                      (
                            'Export table',
                            'Import table',
...
section_headers_tab = ('Section Headers',
                       ['Name', 'Virtual Size', 'Virtual Address',
                        ...
                        'Pointer to Relocations', 'Pointer to Line Numbers',
